              ...
              return (
                <View style={styles.doseCard}>
                  ...
                  <View style={styles.medicineName}>
                    <Text style={styles.dosageInfo}>name</Text>
                    <Text>Dosage</Text>
                  </View>
            ...
            {[].map((medication) => (
              <View>
                <View style={styles.notificationItem}>
                  <Ionicons name="medical" size={24}  style={styles.notificationTitle}/>
                </View>
                <View style={styles.notificationContent} >
                  ...
                  <Text style={styles.notificationTitle}>medication time</Text>
                </View>
              </View>
            ))}
          </View>
